require 'spec_helper'
	...
	describe User do
		...
		describe "when tname is too long" do
		...
		describe "when email format is invalid" do
			it "should be invalid" do
				addresses= %w[user@foo,com user_at_fo.org user@example.]
		...
		describe "when email format is valid" do
			it "should be valid" do
				addresses = %w[user@foo.com A_USER@f.b.org frst.lst@foo.jp a+b@cmm.com]
